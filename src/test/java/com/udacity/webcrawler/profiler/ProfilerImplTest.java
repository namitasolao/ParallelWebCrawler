...
import com.udacity.webcrawler.ParallelWebCrawlerTest;
import com.udacity.webcrawler.SequentialWebCrawler;
...
public final class ProfilerImplTest {
  ...
  CrawlerConfiguration config =
          new CrawlerConfiguration.Builder()
                  ...
                  .setParallelism(12)
                  .setProfileOutputPath("profileTestData.txt")
                  .build();
  private final Profiler profiler = new ProfilerImpl(clock, config);
